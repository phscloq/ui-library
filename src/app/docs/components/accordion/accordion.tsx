...
export function AccordionTriple(){
    ...
    return(
        ...
        onClick={()=>{toggleAccordion(0)}}>
            <span>Section 1</span>
            {accordionArr[0] ? <span className=" rotate-90">{'>'}</span>:<span className="rotate-90">{'<'}</span>}
        </button>
        <div
...
<p className="overflow-hidden">Lorem ipsum dolor sit amet consectetur adipisicing elit. Officiis ad quasi eius cupiditate assumenda eaque numquam deleniti. Iusto autem quidem obcaecati alias dolor animi, eligendi aliquid eos dolorem voluptates maiores?</p>
        ...
        onClick={()=>{toggleAccordion(1)}}>
            <span>Section 2</span>
            {accordionArr[1] ? <span className=" rotate-90">{'>'}</span>:<span className="rotate-90">{'<'}</span>}
        </button>
        <div
className={`grid overflow-hidden transition-all duration-300 ease-in-out text-slate-600  text-sm ${
  accordionArr[1]
...
<p className="overflow-hidden">Lorem ipsum dolor sit amet consectetur adipisicing elit. Officiis ad quasi eius cupiditate assumenda eaque numquam deleniti. Iusto autem quidem obcaecati alias dolor animi, eligendi aliquid eos dolorem voluptates maiores?</p>
        ...
        onClick={()=>{toggleAccordion(2)}}>
            <span>Section 3</span>
            {accordionArr[2] ? <span className=" rotate-90">{'>'}</span>:<span className="rotate-90">{'<'}</span>}
        </button>
        <div
className={`grid overflow-hidden transition-all duration-300 ease-in-out text-slate-600 text-sm ${
  accordionArr[2]
